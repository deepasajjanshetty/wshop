                ...
                <div class="bg-white/10 backdrop-blur-md rounded-3xl shadow-2xl border border-white/20 p-8">
                    ...
                    <div class="text-center mb-8">
                        <div class="flex items-center justify-center mb-6">
                            ...
                            <span class="text-3xl font-bold bg-gradient-to-r from-white to-blue-200 bg-clip-text text-transparent">wshop</span>
                        </div>
                        <h1 class="text-2xl font-bold text-white mb-2">Welcome Back</h1>
                        <p class="text-white/70">Sign in to your account to continue shopping</p>
                    </div>
                    ...
                    <form @submit.prevent="submit" class="space-y-6">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input
                                    ...
                                    class="w-full pl-12 pr-4 py-4 bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300"
                        ...
                        <button
                            ...
                            class="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white py-4 px-6 rounded-2xl font-semibold hover:from-blue-700 hover:to-purple-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 transform hover:scale-105 shadow-lg"
                        >
                    ...
                    <div class="text-center">
                        <p class="text-white/70 text-sm">
                            ...
                            <Link :href="route('register')" class="text-blue-300 hover:text-blue-200 font-semibold transition-colors duration-300">
                                Sign up here
                            </Link>
                        </p>
                    </div>
