            ...
            <div class="relative z-10 w-full max-w-md">
                <div class="bg-white/10 backdrop-blur-md rounded-3xl shadow-2xl border border-white/20 p-8">
                    ...
                    <div class="text-center mb-8">
                        ...
                        <p class="text-white/70">Join us and start your shopping journey</p>
                    </div>
                    ...
                    <div class="text-center">
                        <p class="text-white/70 text-sm">
                            ...
                            <Link :href="route('login')" class="text-blue-300 hover:text-blue-200 font-semibold transition-colors duration-300">
                                Sign in here
                            </Link>
                        </p>
                    </div>
